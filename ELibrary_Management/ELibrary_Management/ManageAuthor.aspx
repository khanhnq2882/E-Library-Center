<%@ Page Title="" Language="C#" MasterPageFile="~/sidebar.master" AutoEventWireup="true" CodeBehind="ManageAuthor.aspx.cs" Inherits="ELibrary_Management.ManageAuthorPublisher" %>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <a href="ManageAuthor.aspx" class="btn btn-primary waves-effect waves-light m-r-40" style="font-size: 18px; padding: 2px 15px; font-size: 18px;"><i class="fas fa-book-open" style="margin: 0; margin-right: 10px; font-size: 18px; color: white;"></i>Add new author</a>
                </div>
            </div>
            <div class="row w-100">
                <div class="col-md-6" style="border-right: 1px solid; padding: 25px 130px;">
                    <div class="col-md-12 text-center m-b-15">
                        <h3>Author Detail</h3>
                        <img src="img/member_img/user-blank.png" style="width: 115px; border: 1px solid #ccc; border-radius: 5px;" />
                    </div>
                    <div class="form-material flex-column">
                        <div class="form-group form-default">
                            ...
                            <label class="float-label">Author ID</label>
                            <% } %>
                        </div>
                        <div class="form-group form-default">
                    ...
                    <div class="card-block table-border-style">
                        <asp:GridView ID="GridView1" class="table text-center" runat="server" AutoGenerateColumns="False" Style="width: 100%;" HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Author ID" DataField="AuthorID" />
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div>
                                            ...
                                            &nbsp;&nbsp;
                                    <a href="ManageAuthor.aspx?id=<%# Eval("AuthorID") %>&action=edit" title="Edit"><i class="fas fa-edit" style="color: orange; font-size: 26px; margin: 0 5px;"></i></a>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
